...
function ContactUs() {
  ...
  return (
    ...
    <div className="w-full md:bg-gradient-to-b md:from-white md:to-blue-50">
      {/* Content container */}
      <div className="w-[95%] md:w-4/5 mx-auto min-h-screen px-4 py-12 md:py-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          >
            <h1 className="text-5xl md:text-5xl lg:text-7xl font-bold text-[#0496ff] tracking-tight leading-tight">
              Contact us
            </h1>

            <p className="text-xl md:text-md  tracking-tight lg:text-md text-gray-800 font-medium">
              In case you have any query, or want any details about the type of{" "}
              <span className="text-[#0496ff] font-bold">Donations</span> or
          ...
          >
            <div className="bg-white p-6 md:p-8 rounded-sm shadow-md border border-blue-100">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-[#0496ff]">
                  Get in Touch
                </h2>
                <Mail className="w-6 h-6 text-[#0496ff]" />
              </div>
              ...
              <form onSubmit={handleContactUs} className="space-y-6">
                ...
                <div className="flex justify-start">
                  <motion.button
                    type="submit"
                    className="flex items-center justify-center space-x-2 w-full md:w-auto px-6 py-2.5 text-sm md:text-base font-medium text-white bg-[#0496ff] rounded-none hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 disabled:opacity-50 transition-all duration-200"
