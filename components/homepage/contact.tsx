    ...
    <div className="w-full md:bg-gradient-to-b md:from-white md:to-blue-50">
      ...
      <div className="w-[95%] md:w-4/5 mx-auto min-h-screen px-4 py-12 md:py-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          >
            <h1 className="text-5xl md:text-5xl lg:text-7xl font-semibold text-blue-900 leading-tight">
              Contact us
            </h1>

            <p className="text-xl md:text-xl italic lg:text-lg text-gray-800 font-medium">
